...
namespace BMBIFVTE
{
	public class HarmonyPatches : Mod
	{
		public HarmonyPatches(ModContentPack content) : base(content)
		{
            ...
            TypeByName("Hospitality.Mod_Hospitality")?.AccessMethod("UpdateMainButtonIcon")?.Patch(harmony, transpiler: new HarmonyMethod(typeof(HarmonyPatches), nameof(Hospitality)));
		}
